---
title: Architecture
description: System architecture and design overview of astro-polyglot.
slug: latest/architecture
---

This page describes the architecture of astro-polyglot, covering the plugin system, handler dispatch, MDX generation pipeline, and package structure.
...
flowchart TB
    ...
    subgraph Core["astro-polyglot Core"]
