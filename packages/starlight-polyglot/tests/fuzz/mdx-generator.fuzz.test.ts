...
function fuzzString(maxLen: number): string {
  ...
  for (let i = 0; i < len; i++) {
    ...
    switch (mode) {
      case 0:
        chars.push(String.fromCharCode(randomInt(0x20, 0x7e)));
        break;
      case 1:
        chars.push(String.fromCharCode(randomInt(0x80, 0x10ff)));
        break;
      case 2:
        chars.push(String.fromCharCode(randomInt(0x2000, 0x206f)));
        break;
      case 3:
        chars.push(String.fromCharCode(randomInt(0, 31)));
        break;
      case 4:
        chars.push(String.fromCharCode(0xfeff));
        break;
    }
  }
  return chars.join("");
   ...
   */
  function _fuzzModule(): ASTModule {
